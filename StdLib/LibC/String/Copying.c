...
/** Do not define memcpy for IPF+GCC or ARM/AARCH64+GCC builds.
    ...
    For ARM/AARCH64/LOONGARCH64/RISCV64, the memcpy function is provided by the
    CompilerIntrinsics library.
**/
#if !((defined(MDE_CPU_IPF) || defined(MDE_CPU_ARM) || defined(MDE_CPU_AARCH64) || defined(MDE_CPU_LOONGARCH64) || defined(MDE_CPU_RISCV64)) && defined(__GNUC__))
